...
\end{block}
  ...
  \begin{itemize}
  \item {
    Semi-discretization on (\ref{eq:Free Vibration}) yields
    \begin{equation}
    ...
    \footnotesize
    \begin{align*}
    A  = \left[ A_{ij} \right] & = \iiint\limits_{\Omega} \overline{\epsilon}\left( \varphi_i \right)^T C\overline{\epsilon}\left( \varphi_j \right) \mathrm{d} V \\
    M  = \left[ M_{ij} \right] &= \iiint\limits_{\Omega} \ \rho \varphi_{i}^T \varphi_j \mathrm{d} V \\ 
    \end{align*}
    \normalsize
  }
  \item {
